...
# Boltzmann constant [erg K⁻¹]           NIST CODATA 2014
k_B = 1.3806488e-16
# atomic mass unit [g]                    NIST CODATA 2014
amu = 1.66053892e-24
...
MINERALS: dict[str, MineralEntry] = {
    ...
    # enstatite
    "MgSiO3":  MineralEntry(68908, 38.1, 100.389, "van Lieshout+ 2014"),
    # corundum
    "Al2O3":   MineralEntry(77365, 39.3, 101.961, "van Lieshout+ 2014; Schaefer & Fegley 2004"),
    "SiO":     MineralEntry(49520, 32.5,  44.085, "van Lieshout+ 2014"),
    # silicon carbide
    "SiC":     MineralEntry(78462, 37.8,  40.10,  "van Lieshout+ 2014"),
    # quartz
    "SiO2":    MineralEntry(69444, 33.1,  60.084, "van Lieshout+ 2014"),
    # graphite
    "C":       MineralEntry(93646, 36.7,  12.011, "van Lieshout+ 2014"),
    # forsterite (Io mantle 76–85%, Sohl 2002)
    "Mg2SiO4": MineralEntry(65308, 34.1, 140.694, "van Lieshout+ 2014"),
    # fayalite
    "Fe2SiO4": MineralEntry(60377, 37.7, 203.774, "van Lieshout+ 2014"),
    ...
    #
    # T_boil ≈ 3146 K
    "Fe":      MineralEntry(48354, 29.2,   55.845, "van Lieshout+ 2014 (Table 3)"),
    # T_boil ≈ 3115 K
    "Ni":      MineralEntry(47813, 29.178, 58.693, "fit to Alcock+ 1984 (liquid)"),
    # solid-phase fit; bp~2944 K extrapolated
    "Cr":      MineralEntry(48748, 33.328, 51.996, "fit to Alcock+ 1984 (solid)"),
    # T_boil ≈ 2334 K
    "Mn":      MineralEntry(31535, 28.087, 54.938, "fit to Alcock+ 1984 (solid)"),
    # T_boil ≈ 3172 K
    "Co":      MineralEntry(47383, 28.768, 58.933, "fit to Alcock+ 1984 (liquid)"),
    # T_boil ≈ 1143 K
    "Na":      MineralEntry(12381, 24.660, 22.990, "fit to Alcock+ 1984 (liquid)"),
    # T_boil ≈ 1012 K
    "K":       MineralEntry(10253, 23.965, 39.098, "fit to Alcock+ 1984 (liquid)"),
    ...
    # T_boil ≈ 1738 K
    "NaCl":    MineralEntry(27627, 29.724, 58.443, "NIST-JANAF / CRC; Lamoreaux & Hildenbrand 1984"),
    # T_boil ≈ 1690 K
    "KCl":     MineralEntry(25979, 29.201, 74.551, "NIST-JANAF / CRC; Lamoreaux & Hildenbrand 1984"),
    ...
    # bunsenite
    "NiO":     MineralEntry(55325, 38.638, 74.692, "NIST-JANAF (Chase 1998); decomposes ≈2230 K"),
    # lime, T_vap ≈ 3120 K
    "CaO":     MineralEntry(69758, 36.187, 56.077, "NIST-JANAF (Chase 1998)"),
    # wollastonite
    "CaSiO3":  MineralEntry(74600, 34.902, 116.162, "Sossi+ 2019 (incongruent)"),
    # rutile, T_vap ≈ 3245 K
    "TiO2":    MineralEntry(67954, 34.770,  79.866, "NIST-JANAF (Chase 1998)"),
    ...
    # troilite
    "FeS":     MineralEntry(37886, 32.817,  87.910, "JANAF; Ferrante+ 1971 (congruent, incongruent above ~1460 K)"),
    # millerite
    "NiS":     MineralEntry(39690, 41.712,  90.758, "JANAF; Rosenqvist 1954 (decomposes near ~1070 K)"),
}
